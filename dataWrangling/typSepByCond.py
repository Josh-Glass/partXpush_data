...
df = pd.read_csv('typResults_metCrit.csv')
...
cond1_df.to_csv( "c1typResults.csv", index=False, encoding='utf-8-sig')
...
cond2_df.to_csv( "c2typResults.csv", index=False, encoding='utf-8-sig')
...
cond3_df.to_csv( "c3typResults.csv", index=False, encoding='utf-8-sig')
