...
df0 = pd.read_csv('C:/Users/apers/partXpush_data/dataWrangling/c3Results.csv')
...
df.to_csv('C:/Users/apers/partXpush_data/Generalization/subc3groupby_extenders.csv')