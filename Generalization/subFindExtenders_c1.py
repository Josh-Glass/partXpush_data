...
df0 = pd.read_csv('C:/Users/apers/partXpush_data/dataWrangling/c1Results.csv')


#drop trainPhase and subTestPhase
for item in df0['id']:
    df = df0.drop(index = df0[df0['phase'] != 'subTestPhase'].index)
...
df.to_csv('C:/Users/apers/partXpush_data/Generalization/subc1groupby_extenders.csv')
