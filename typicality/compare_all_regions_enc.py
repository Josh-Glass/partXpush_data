...
df_a = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
df_b = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
df_w = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
df_x = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
df_y = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
df_z = pd.read_csv('typicality\persubj_encourageTyps_percat.csv')
...
ax.set_title('Encourage: Typicality scores per region')
ax.yaxis.grid(True)

# Save the figure
#plt.tight_layout()
plt.savefig('typicality/per_Region_Typ_enc.png')
